...
st.sidebar.markdown('<b>This is an one of a kind website where you just need to upload a clean csv file and it would assist you in finding the best regressor or classifier which best suits your dataset</b>', unsafe_allow_html=True)
...
if st.button("Regression"):
    ...
    if(((r1>r2) and (r1>r3)) and (r1>r4)):
        ...
        print('Use XGBoost for regression')
if st.button("Classification"):
    ...
    if(((acc1>acc2) and (acc1>acc3)) and ((acc1>acc4) and (acc1>acc5)) and ((acc1>acc6) and (acc1>acc7))):
        ...
        print('Use XGBoost for Classification')
